...
const StandardSection: FC<PropsWithChildren<SectionProps>> = ({
    ...
    return (
        <section className="py-24 xl:px-64 lg:px-48 md:px-24 px-12">
...
const AltSection: FC<PropsWithChildren<SectionProps>> = ({
    ...
    return (
        <section className="py-24 xl:px-64 lg:px-48 md:px-24 px-12 bg-emerald-700 text-slate-100 text-right">
            <div className="xl:flex xl:gap-36">
